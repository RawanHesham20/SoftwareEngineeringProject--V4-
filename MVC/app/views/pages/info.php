...
class info extends view
{
  ...
  public function output()
  {
    ...
    $workers=$this->model->getAllWorkers();
      ...
      <div class="table-responsive">
          <div class="table-wrapper">
              <div class="table-title">
                  <div class="row">
                      <div class="col-sm-4">
                    <button style= 'background-color: transparent; border:black;'><a href='AddWorker' style ='color: #FF1493';class='edit' title='Edit' data-toggle='tooltip'><i class='fas fa-plus' style='font-size:48px;color:pink'></i>Add New Worker</a></button>
                      </div>
                  </div>
              </div>
            </div>
